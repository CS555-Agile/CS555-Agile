    ...
    public void createID(String value, String tag) throws ParseException {
        ...
        if (married) {
            ...
            if (husDeath != null && marrDt.compareTo(husDeath) > 0) {
                ...
                System.out.println("Marriage after Death - Husband "+Famobj.gethName());
            }

            if (wifeDeath != null && marrDt.compareTo(wifeDeath) > 0) {
                System.out.println("Marriage after Death - Wife "+Famobj.getwName());
            }
        ...
        if (divorced) {
            ...
            if (husDeath != null && divDt.compareTo(husDeath) > 0) {

                System.out.println("Divorce after Death - Husband "+Famobj.gethName());
            }

            if (wifeDeath != null && divDt.compareTo(wifeDeath) > 0) {
                System.out.println("Divorce after Death - Wife "+Famobj.getwName());
            }
